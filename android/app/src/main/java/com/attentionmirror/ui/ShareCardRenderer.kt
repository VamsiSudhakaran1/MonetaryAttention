...
object ShareCardRenderer {
    ...
    fun render(card: ShareCardText): Bitmap {
        ...
        y += 96f
        for ((value, caption) in card.stats) {
            canvas.drawText(value, MARGIN, y, numberPaint)
            y += 46f
